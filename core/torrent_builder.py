...
from utils.parsing import process_trackers
from utils.parsing import add_audio_tag_if_needed
from utils.text import create_standardized_title, prepare_release_title
...
def build_torrent_from_magnet(
    *,
    ...
    if not missing_dn and magnet_original and not _looks_like_bludv_processed_release_name(magnet_original):
        try:
            from utils.text import save_release_title_to_redis
    ...
    from utils.parsing import determine_legend_presence
