...
from core.torrent_enricher_async import TorrentEnricherAsync
from core.torrent_processor import QueryFilter, TorrentProcessor
from scraper import available_scraper_types, create_scraper, normalize_scraper_type

FLARESOLVERR_POR_PADRAO = frozenset({'bludv', 'comand'})


def usa_flaresolverr_por_padrao(scraper_type: str) -> bool:
    return scraper_type in FLARESOLVERR_POR_PADRAO
...
def get_scraper_info() -> Dict:
    ...
    for scraper_type, meta in types_info.items():
        meta['use_flaresolverr_default'] = usa_flaresolverr_por_padrao(scraper_type)
